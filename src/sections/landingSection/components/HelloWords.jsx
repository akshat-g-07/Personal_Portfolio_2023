...
const HelloWords = () => {
  ...
  return (
    ...
    // <div className="w-24 pl-3 md:w-44 text-white border-r-8 text-2xl md:text-5xl font-helloWordsFont overflow-y-clip overflow-x-hidden animate-helloWordsAnimation origin-left">
    //   {helloWords[wordIndex]}
    // </div>
  );
};
